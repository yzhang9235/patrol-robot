...
mkdir -p weights
cd weights
wget https://github.com/IDEA-Research/GroundingDINO/releases/download/v0.1.0-alpha/groundingdino_swint_ogc.pth 或者 curl -L -o groundingdino_swint_ogc.pth https://github.com/IDEA-Research/GroundingDINO/releases/download/v0.1.0-alpha/groundingdino_swint_ogc.pth
cd ..
```
...
python3 calibrate_with_dino.py \
    ...
    --dino-checkpoint /Users/elaine/Desktop/巡检/GroundingDINO/weights/groundingdino_swint_ogc.pth
```
